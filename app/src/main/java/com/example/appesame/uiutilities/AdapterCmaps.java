...
public class AdapterCmaps  extends RecyclerView.Adapter<AdapterCmaps.CViewHolder> {

    private List<EntityCmap> dataList;
    private OnItemClickListener mlistener;
    private LayoutInflater layoutInflater;

    public AdapterCmaps (Context context) {
    ...
    public CViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.rv_cmap,parent,false);
    ...
    public void setDataList(List<EntityCmap> dataList) {
        this.dataList = dataList;
        notifyDataSetChanged();
    }

    public EntityCmap get(int position) {
    ...
    static class CViewHolder extends RecyclerView.ViewHolder{
        ...
        public CViewHolder(@NonNull View itemView, final OnItemClickListener listener) {
            ...
            textView = itemView.findViewById(R.id.textView_c);
            checkBox = itemView.findViewById(R.id.checkBox_c);
            delBtn = itemView.findViewById(R.id.delete_btn_c);
            RowLayout = itemView.findViewById(R.id.cmap_row_layout);
